 ...
 <div class="tools clearfix" style="width:100%;background-color:#5CACEE;">
  ...
  <div class="nav-bg">
     <ul class="nav">
      ...
      <li style="margin-left:56px;font-size:12pt;"><a class="active" href="${ctx}/yiZhuanDetails/teachersDetails">课程介绍</a></li>
...
<div class="warp">
  ...
  <div class="listpage clearfix">
    <div class="lmenu"  style="height:100px;">
      <h2>分类导航</h2>
      <ul class="menus">
        <li><a class="menulink active" href="#">课程介绍</a></li>
      </ul>
    </div>
    <div class="rcon">
      <ol class="breadcrumb">
        <li><a href="#">课程</a></li>
        <li class="active"> - 课程 - 详细信息</li>
      </ol>
      <div class="newscon" style="width:100%;">
      <h2>必修课程</h2>
      <table style="width:98%;height:100%;border:1px solid #F4F4F4;box-shadow:10px;">
           <tr>
               <td rowspan="4" style="width:230px;height:130px;border:1px solid #F4F4F4" >
...
<div class="footer-bg">
  <div class="footer wc1000">
    ...
    <p class="mt15">Copyright	2019【张德举】</p>
  </div>
</div>
