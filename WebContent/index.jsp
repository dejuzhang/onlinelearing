...
<div class="header" style="">
  ...
  <div class="nav-bg" style="margin-top:-18px;">
    <ul class="nav">
      <li style="margin-left:100px;font-size:12pt;"><a class="active" href="/OnlineLearning/InitIndexInf">首页</a></li>
	  <li style="margin-left:56px;font-size:12pt;"><a href="#projectIntroduction">关于项目</a></li>
      <li style="margin-left:56px;font-size:12pt;"><a href="${ctx}/yiZhuanDetails/teachersDetails">课程介绍</a></li>
      <li style="margin-left:56px;font-size:12pt;"><a href="${ctx}/yiZhuanDetails/videoAppreciation">课程学习</a></li>
...
<div class="warp" style="margin-top:-17px;">
  <div class="banner" style="margin-top:-10px;">
    <div class="change-box">
      <div class="img-box ads-one active"><img alt="" src="${resourcePath}/images/lunbo1.jpg" width="100%" /></div>
      <div class="img-box ads-two"><img alt="" src="${resourcePath}/images/lunbo2.jpg" width="100%"/></div>
      <div class="img-box ads-three"><img alt="" src="${resourcePath}/images/lunbo3.png" width="100%" /></div>
    </div>
  ...
  <div class="news-moudle clearfix">
    <div class="news-pic mr15" >
      <ul class="pic-box">  
        <li class="act"><img src="${resourcePath}/images/course1.png" width="324" height="191" /></li>
        <li><img src="${resourcePath}/images/spring.png" width="324" height="191" /></li>
        <li><img src="${resourcePath}/images/springboot.jpg" width="324" height="191" /></li>
      </ul>
  ...
  <div class="clearfix">
    <div class="left">
      ...
      <div class="bbs">
        <a name="projectIntroduction">本课题旨在实现在线学习系统，通过该系统，减轻教务人员的工作负担，提高教学质量，提高教学资源利用率，实现测试标准化，建立教学资源库，形成特色在线考试、学习、辅导平台。
        </a>
      </div>
    </div>
    <div class="right">
    ...
    <div class="box-list" id="Marquee_x" style="width:60%;height:230px;float:left;">
      <ul class="img-lists clearfix" style="width:60%;height:230px;">
        <li style="width:150px;height:230px;">
          <img alt="" src="${resourcePath}/images/daolun.png" width="100%" height="100%" />
          <a href="${ctx}/yiZhuanDetails/teachersDetails" class="">数据结构于算法</a>
		  <p>简介:独特的教学方法</P>
        </li>
        <li style="width:150px;height:230px;">
          <img alt="" src="${resourcePath}/images/cpp.jpg" width="100%" height="100%"/>
          <a href="${ctx}/yiZhuanDetails/teachersDetails" class="">计算机网络</a>
		  <p>简介:是学习让我变得快乐</P>
        </li>
        <li style="width:150px;height:230px;">
          <img alt="" src="${resourcePath}/images/jisuanji.jpg" width="100%" height="100%"/>
          <a href="${ctx}/yiZhuanDetails/teachersDetails" class="">操作系统</a>
		  <p>简介:与学生打成一片</P>
        </li>
        <li style="width:150px;height:230px;">
          <img alt="" src="${resourcePath}/images/database.jpg" width="100%" height="100%"/>
          <a href="${ctx}/yiZhuanDetails/teachersDetails" class="">编译原理</a>
		  <p>简介:因才施教</P>
        </li>
        <li style="width:150px;height:230px;">
          <img alt="" src="${resourcePath}/images/java.jpg" width="100%" height="100%" />
          <a href="${ctx}/yiZhuanDetails/teachersDetails" class="">Python语言程序设计</a>
		  <p>简介:独特的教学方法</P>
        </li>
        <li style="width:150px;height:230px;">
          <img alt="" src="${resourcePath}/images/python.png" width="100%" height="100%"/>
          <a href="${ctx}/yiZhuanDetails/teachersDetails" class="">计算机组成原理</a>
		  <p>简介:是学习让我变得快乐</P>
        </li>
        <li style="width:150px;height:230px;">
          <img alt="" src="${resourcePath}/images/sujujiegou.jpg" width="100%" height="100%"/>
          <a href="#" class="">PHP网站动态开发</a>
		  <p>简介:与学生打成一片</P>
        </li>
        <li style="width:150px;height:230px;">
          <img alt="" src="${resourcePath}/images/webqianduan.jpg" width="100%" height="100%"/>
          <a href="${ctx}/yiZhuanDetails/teachersDetails" class="">Java语言程序设计</a>
		  <p>简介:因才施教</P>
        </li>
        <li style="width:150px;height:230px;">
          <img alt="" src="${resourcePath}/images/weijiyuanli.jpg" width="100%" height="100%"/>
          <a href="${ctx}/yiZhuanDetails/teachersDetails" class="">软件工程</a>
		  <p>简介:与学生打成一片</P>
        </li>
        <li style="width:150px;height:230px;">
          <img alt="" src="${resourcePath}/images/zuchengyuanli.jpg" width="100%" height="100%"/>
          <a href="${ctx}/yiZhuanDetails/teachersDetails" class="">就业指导</a>
		  <p>简介:因才施教</P>
        </li>
      </ul>
    </div>
...
<div class="footer-bg">
  <div class="footer wc1000">
    ...
    <p class="mt15">Copyright	© 2020   实践课在线培训系统  版权所有</p>
