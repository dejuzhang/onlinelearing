...
public class Login_MgController {
	 ...
	 * @author 张德举 forward与redirect的区别 forward数据转发可转发数据redirect重定向无法转发数据
	 */
	@RequestMapping(value = "/loginAdmin", method = RequestMethod.POST)
	public String loginAdmin(Model model, @RequestParam("loginname") String loginname, @RequestParam("psw") String psw,
